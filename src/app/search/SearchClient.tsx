      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full rounded-[10px] border border-[#3A3A3A] bg-surface px-4 py-3 text-sm text-white focus:outline-none focus:ring-2 focus:ring-[var(--primary-purple)]"
          />
        </div>
        ...
        {results.length === 0 ? (
          <div className="p-6 bg-surface rounded-lg">No products found for &quot;{query}&quot;</div>
        ) : (
