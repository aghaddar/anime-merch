...
function ProductCard({ product }: ProductCardProps) {
  return (
    <div className="w-[345px] h-[440px] mx-auto bg-[#302F2F] rounded-lg shadow-lg overflow-hidden flex flex-col flex-shrink-0">
      ...
      <div className="bg-[#302f2f] text-white p-4 h-[190px] w-[345px] flex flex-col justify-between">
        ...
        {/* Add to Cart Button */}
        <button className="w-full h-10 bg-[#ab03e3] hover:bg-[#9602cc] text-white font-semibold rounded-lg transition-colors duration-200 text-sm flex items-center justify-center">
          Add To Cart
        </button>
      </div>
    </div>
