...
function ProductCard() {
  return (
    <div className="w-[345px] h-[440px] mx-auto bg-[#302F2F] rounded-lg shadow-lg overflow-hidden flex flex-col">
      ...
      <div className=" relative h-[250px] w-[345px] bg-amber-900">
        ...
        <div className="flex h-full w-full  justify-center  items-center">
          <Image
            src="/anime-hoodie.jpg"
            alt="The Gojo Hoodie - Black hoodie with anime character artwork"
            fill
      ...
      <div className="bg-[#302f2f] text-white p-4 h-[190px] w-[345px] flex flex-col justify-between">
        <div>
          <h2 className="text-xl font-bold mb-2">The Gojo Hoodie</h2>

          {/* Rating */}
          <div className="flex items-center gap-2 mb-2">
            <div className="flex">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="w-3 h-3 fill-[#e6a100] text-[#e6a100]" />
              ))}
            </div>
            <span className="text-[#a4a1a1] text-xs">(150 reviews)</span>
          </div>
        ...
        {/* Add to Cart Button */}
        <button className="w-full h-10 bg-[#ab03e3] hover:bg-[#9602cc] 
